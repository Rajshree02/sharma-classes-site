    ...
    <section id="about">
      <div className="container about">
        ...
        <div>
          ...
          <ul>
            <li><span className="title"></span><div><strong style={{ fontSize: '1.5em' }}>Qualifications/Achievements:</strong><br /><br /> B.E from VNIT Nagpur<br /> M.Tech in Industrial form VNIT Nagpur<br /> GATE SCORE: 90.91 percentile <br /> CET/JEE rank: 1935 <br /> Ex-Lecturer of RCOEM</div></li>
          </ul>
        </div>
      </div>
    </section>
